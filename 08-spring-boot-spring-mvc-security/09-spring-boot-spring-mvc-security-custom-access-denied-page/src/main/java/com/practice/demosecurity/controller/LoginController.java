...
public class LoginController {
    ...
    @GetMapping("/access-denied")     // this URL must match the DemoSecurityConfig's access denied URL
    public String showAccessDeniedPage() {
        return "access-denied";           // src/main/resources/templates/access-denied.html
    }
}
